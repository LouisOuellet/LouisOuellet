<div align="justify" style="padding: 20px;">
    <h1 style="text-align:center;border-bottom:0px; padding-bottom: 0px; margin-bottom: 32px; width: 100%;">Hi :wave:, I'm <a href="https://laswitchtech.com">Louis Ouellet</a></h1>
    ...
    <h2 style="border-bottom:0px; padding-bottom: 0px; margin-bottom: 32px;">:hammer: Check out what I'm currently working on</h2>
    <table align="left">
        <tr>
            <th>Repository</th>
            <th>Description</th>
    ...
    <h2 style="border-bottom:0px; padding-bottom: 0px; margin-bottom: 32px;">:page_with_curl: I recently blogged about...</h2>
    <table align="left">
    ...
    <h2 style="border-bottom:0px; padding-bottom: 0px; margin-bottom: 32px;">:bar_chart: All the statistics</h2>
    <div>
